...
| exp04b | LingBot-VA (full WAM, video imagination + action) E/V/A profiling on RTX 5880 Ada | **done** | E=75.5ms/V=592.5ms(20 steps)/A=1423.1ms(50 steps), total 2091ms (0.5Hz). **Full WAM 5x slower than skip-imagination.** Video denoise ~29.6ms/step, action ~28.5ms/step (same DiT, similar per-step cost). Action dominates 68% (consistent with Fast-WAM pattern). 0.5Hz makes real-time impossible — research-grade only. |
| exp05a | LingBot-VLA-4B attention analysis (6 layers: 0,7,14,21,28,35) | **pending** | — |
| exp06a | NitroGen 500M DiT E/C/A profiling + k sweep (1/2/4/8/16) on RTX 5880 Ada | **pending** | — |
