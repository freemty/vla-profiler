...
| exp04a | Fast-WAM (ActionDiT, skip-imagination WAM) E/A profiling on RTX 5880 Ada | **planned** | Target: measure 190ms breakdown (SigLIP encode / ActionDiT context / flow matching action). First WAM in profiling spectrum. Compare with LingBot-VLA (74.5ms) and full WAM (LingBot-VA ~200ms). |
