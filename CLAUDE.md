...
- **Cosmos Policy Deep-Dive (2026)**: `survey/papers/cosmos-policy-deep-dive.md` — NVIDIA+Stanford ICLR 2026, unified video-policy (Cosmos-Predict2-2B DiT + latent frame injection), LIBERO 98.5% / RoboCasa 67.1% SOTA. Pure DiT homogeneous = FastVideo 加速术直接可迁移, candidate A workload 强候选. **exp09a 实测: direct-mode 1362ms / 0.73Hz** (5-step, RTX 5880 Ada), per-step 272ms, VRAM 8816MB.
