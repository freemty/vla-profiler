...
- **Reproducibility Spec (v0.9.0)**: `docs/specs/2026-04-28-reproducibility-spec.md` — 7 模型官方配置合约, 已知偏差 (NitroGen 缩小/Fast-WAM 10步/Pi-Zero 随机权重) 文档化, exp09 对齐基准
...
- **Cosmos Policy Deep-Dive (2026)**: `survey/papers/cosmos-policy-deep-dive.md` — NVIDIA+Stanford ICLR 2026, unified video-policy (Cosmos-Predict2-2B DiT + latent frame injection), LIBERO 98.5% / RoboCasa 67.1% SOTA. Pure DiT homogeneous = FastVideo 加速术直接可迁移, candidate A workload 强候选. Direct-mode latency 论文零报告是关键缺口。
